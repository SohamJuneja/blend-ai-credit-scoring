...
export const EnvironmentConfig = {
  STELLAR_EXPERT_URL: process.env.NEXT_PUBLIC_STELLAR_EXPERT_URL || 'https://stellar.expert/explorer/testnet',
  ...
  BACKSTOP: process.env.NEXT_PUBLIC_BACKSTOP || 'CC4TSDVQKBAYMK4BEDM65CSNB3ISI2A54OOBRO6IPSTFHJY3DEEKHRKV',
  BACKSTOP_V2: process.env.NEXT_PUBLIC_BACKSTOP_V2 || 'CC4TSDVQKBAYMK4BEDM65CSNB3ISI2A54OOBRO6IPSTFHJY3DEEKHRKV',
  USDC_ISSUER: process.env.NEXT_PUBLIC_USDC_ISSUER || 'GATALTGTWIOT6BUDBCZM3Q4OQ4BO2COLOAZ7IYSKPLC2PMSOPPGF5V56',
  BLND_ISSUER: process.env.NEXT_PUBLIC_BLND_ISSUER || 'GATALTGTWIOT6BUDBCZM3Q4OQ4BO2COLOAZ7IYSKPLC2PMSOPPGF5V56',
  BLEND_POOL_CONTRACT: process.env.NEXT_PUBLIC_BLEND_POOL_CONTRACT || 'CCLBPEYS3XFK65MYYXSBMOGKUI4ODN5S7SUZBGD7NALUQF64QILLX5B5',
